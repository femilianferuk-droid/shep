...
from aiogram.types import (
    ...
    ContentType, BotCommand, BotCommandScopeChat, ReplyKeyboardMarkup, KeyboardButton
)
...
async def process_sbp_screenshot(message: types.Message, state: FSMContext):
    ...
    for admin_id in ADMIN_IDS:
        try:
            ...
            print(f"[DEBUG] Скриншот отправлен админу {admin_id}")
    ...
    print("[DEBUG] Ответ пользователю отправлен")
...
@router.callback_query(F.data == "finish_product", AdminStates.add_product_files)
